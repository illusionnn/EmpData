...
public class GetEmployeeAddForm extends HttpServlet{
	public void doGet(HttpServletRequest request,HttpServletResponse response){
		try{
			...
			pw.println("<td><br><input type='date' id='dateOfBirth' name='dateOfBirth' value='1970-01-01'>");
			pw.println("<span id='dateOfBirthErrorSection' style='color:red'></span>");
			pw.println("</td>");
			pw.println("</tr>");
			pw.println("<tr>");
			pw.println("<td><br>Gender</td>");
			pw.println("<td><br><input type='radio' id='male' name='gender' value='M'>Male");
			pw.println("&nbsp;&nbsp;&nbsp;&nbsp;");
			...
			pw.println("<td><br><input type='checkbox' name='isIndian' id='isIndian'></td>");
			pw.println("</tr>");
			pw.println("<tr>");
			pw.println("<td><br>Basic Salary</td>");
			pw.println("<td><br><input type='text' style='text-align:right' id='basicSalary' name='basicSalary' maxLength='13'>");
			pw.println("<span id='basicSalaryErrorSection' style='color:red'></span>");
			pw.println("</td>");
			pw.println("</tr>");
			pw.println("<tr>");
			pw.println("<td><br>PAN Number</td>");
			pw.println("<td><br><input type='text' id='panNumber' name='panNumber'>");
			pw.println("<span id='panNumberErrorSection' style='color:red'></span>");
			pw.println("</td>");
			pw.println("</tr>");
			pw.println("<tr>");
			pw.println("<td><br>Aadhar Number</td>");
			pw.println("<td><br><input type='text' id='aadharNumber' name='aadharNumber'>");
